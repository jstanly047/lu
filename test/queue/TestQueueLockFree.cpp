...
class TestQueueLockFree : public ::testing::Test
{
protected:
    void SetUp() override 
    {
...
TEST_F(TestQueueLockFree, consumerProducerSequenceCheckForSPSC)
{
    using AtomicQueue = lu::queue::RetryDecorator<lu::queue::AtomicQueue<unsigned int*, QUEUE_SIZE, nullptr, true, true, false, true> >;
