...
class TestMPSCQueue : public ::testing::Test
{
protected:
    void SetUp() override 
    {
...
TEST_F(TestMPSCQueue, consumerProducerSequenceCheckFor_SPSC)
{
    using AtomicQueue = lu::queue::MPSCQueue<lu::queue::AtomicQueue2<unsigned int*, QUEUE_SIZE, true, true, false, true> >;
...
TEST_F(TestMPSCQueue, consumer_SPSC_NoMINIMIZE_CONTENTION)
{
    using AtomicQueue = lu::queue::MPSCQueue<lu::queue::AtomicQueue2<unsigned int*, QUEUE_SIZE, false, true, false, true> >;
    AtomicQueue testQueue{};
...
TEST_F(TestMPSCQueue, consumerProducerSequenceCheck_MPMC_1P_1C)
{
    using AtomicQueue = lu::queue::MPSCQueue<lu::queue::AtomicQueue2<unsigned int*, QUEUE_SIZE> >;
    AtomicQueue testQueue{};
    for (int numberExec = 0; numberExec < NUMBER_TRY ; numberExec++)
    {
        std::chrono::milliseconds produceTime;
...
TEST_F(TestMPSCQueue, consumerProducerCheck_MPSC_2P_1C)
{
    using AtomicQueue = lu::queue::MPSCQueue<lu::queue::AtomicQueue2<unsigned int*, QUEUE_SIZE> >;
    AtomicQueue testQueue{};
    for (int numberExec = 0; numberExec < NUMBER_TRY ; numberExec++)
...
TEST_F(TestMPSCQueue, consumerProducerCheck_MPSC_NoMINIMIZE_CONTENTION_2P_1C)
{
    using AtomicQueue = lu::queue::MPSCQueue<lu::queue::AtomicQueue2<unsigned int*, QUEUE_SIZE, false> >;
    AtomicQueue testQueue{};
    for (int numberExec = 0; numberExec < NUMBER_TRY ; numberExec++)
    {
        std::chrono::high_resolution_clock::time_point producerStartTime[2];
...
TEST_F(TestMPSCQueue, consumerProducerCheck_MPSC_4P_1C)
{
    using AtomicQueue = lu::queue::MPSCQueue<lu::queue::AtomicQueue2<unsigned int*, QUEUE_SIZE> >;
    AtomicQueue testQueue{};
    for (int numberExec = 0; numberExec < NUMBER_TRY ; numberExec++)
